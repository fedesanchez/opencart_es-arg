...
$_['text_checkout_account']          = 'Paso %s: Datos de la cuenta y de facturaci&oacute;n';
$_['text_checkout_payment_address']  = 'Paso %s: Datos de facturaci&oacute;n';
$_['text_checkout_shipping_address'] = 'Paso %s: Datos de Entrega';
$_['text_checkout_shipping_method']  = 'Paso %s: M&eacute;todo de env&iacute;o';
$_['text_checkout_payment_method']   = 'Paso %s: M&eacute;todos de Pago';
$_['text_checkout_confirm']          = 'Paso %s: Confirmar Compra';
$_['text_modify']                    = 'Modificar &raquo;';
$_['text_new_customer']              = 'Nuevo Cliente';
$_['text_returning_customer']        = 'Ya soy Cliente';
$_['text_checkout']                  = 'Opciones de la compra:';
$_['text_i_am_returning_customer']   = 'Ya soy cliente';
$_['text_register']                  = 'Registrar Cuenta';
$_['text_guest']                     = 'Comprar como invitado';
$_['text_register_account']          = 'Al crear una cuenta vas a poder comprar mas rápido, estar al tanto del estado del pedido, y poder hacer un seguimiento de tus operaciones anteriores.';
...
$_['text_trial_description']         = '%s cada %d %s(s) para %d pagos posteriores';
...
$_['entry_shipping'] 	             = 'Mis direcciones de entrega y facturaci&oacute;n son las mismas';
...
$_['error_attempts']                 = 'Advertencia: Usted excedió el límite de intentos. Por seguridad, intente nuevamente después de 1 hora.';
...
$_['error_custom_field_validate']    = 'El campo %s no es válido.';